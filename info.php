...
<head>
    ...
    <title>Informazioni PHP - MATHIAS ULANO</title>
    <style>
        body {
...
<body>
    <div class='header'>
        ...
        <p>Configurazione del server PHP per MATHIAS ULANO</p>
    </div>
    
    <div class='info-box'>
        <h2>📊 Dati Studente</h2>
        <p><strong>Nome:</strong> MATHIAS ULANO</p>
        <p><strong>Classe:</strong> 4CINF</p>
        <p><strong>Username:</strong> ulano.mathias</p>
